...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Register portfolio observers
        \App\Models\ContestResult::observe(\App\Observers\ContestResultObserver::class);
        Document::observe(\App\Observers\DocumentObserver::class);
        
        // Register schedule observers
        \App\Models\ScheduleVersion::observe(\App\Observers\ScheduleVersionObserver::class);
        \App\Models\ScheduleReplacement::observe(\App\Observers\ScheduleReplacementObserver::class);
